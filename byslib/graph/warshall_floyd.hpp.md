...
data:
  ...
  code: "#pragma once\n/**\n * @file warshall_floyd.hpp\n * @brief Warshall Floyd\n\
    ...
    \ {\n/**\n * @brief Warshall Floyd\n *\n * O(V^3)\n *\n * @param graph \u8FBA\u30EA\
    \u30B9\u30C8\n */\n\ntemplate <class E> std::vector<std::vector<typename E::weight_type>>\
    \ warshall_floyd(EdgesCOO<E> const& graph) {\n    using W = typename E::weight_type;\n\
    \    i32 n = graph.size();\n    std::vector cost(n, std::vector(n, get_inf<W>()));\n\
...
documentation_of: byslib/graph/warshall_floyd.hpp
layout: document
redirect_from:
- /library/byslib/graph/warshall_floyd.hpp
- /library/byslib/graph/warshall_floyd.hpp.html
